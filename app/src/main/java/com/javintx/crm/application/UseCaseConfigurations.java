...
public class UseCaseConfigurations {

		private UseCaseConfigurations() {
		}

		public static UserUseCaseHandler initializeUserUseCaseHandler() {
		...
		public static CustomerUseCaseHandler initializeCustomerUseCaseHandler() {
